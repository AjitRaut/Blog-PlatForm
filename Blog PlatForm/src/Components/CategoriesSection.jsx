        ...
        <div className="bg-white p-6 rounded shadow-md w-full max-w-lg mx-auto mt-8 dark:bg-gray-900">
            ...
            <div className="mb-4">
                {categories.map(cat => (
                    <button
                        ...
                        className={`px-4 py-2 mr-2 mb-2 rounded ${selectedCategory === cat ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'} dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700`}
                    >
                        {cat}
                    </button>
                ))}
            ...
            <div>
                ...
                {posts.length > 0 ? (
                    ...
                    <p className="text-gray-700 dark:text-gray-300">No posts available in this category.</p>
                )}
            </div>
        </div>
    );
